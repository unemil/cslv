	...
	cd training/tesstrain && \
		for model in $(MODELS); do \
			...
			if [ "$$model" = "WenQuanYiMicroHei" ]; then \
				TESSDATA_PREFIX=../tesseract/tessdata make training MODEL_NAME=WenQuanYiMicroHei START_MODEL=eng TESSDATA=../tesseract/tessdata MAX_ITERATIONS=$(MAX_ITERATIONS_WENQUANYIMICROHEI) && \
				...
				TESSDATA_PREFIX=../tesseract/tessdata make training MODEL_NAME=DenneThreedee START_MODEL=eng TESSDATA=../tesseract/tessdata MAX_ITERATIONS=$(MAX_ITERATIONS_DENNETHREEDEE) && \
				...
				TESSDATA_PREFIX=../tesseract/tessdata make training MODEL_NAME=ChromosomeHeavy START_MODEL=eng TESSDATA=../tesseract/tessdata MAX_ITERATIONS=$(MAX_ITERATIONS_CHROMOSOMEHEAVY) && \
